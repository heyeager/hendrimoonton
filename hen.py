...
api = 'https://accountmoontonapi.mobilelegends.com/'
...
class MOONTON:
  def __init__(self, url):
    ...
    self.unknown = []
    self.proxy_list = []
    self.api = https://accountmoontonapi.mobilelegends.com/
    self.loop = 0
    print('''\033[0m


    from hendri checker import Colors, Colorate
print(Colorate.Horizontal(Colors.yellow_to_red, "Hello, Welcome to Hendri.", 1))
---------------------------------------------
          - Created By (HendriYeager) -
---------------------------------------------\n''')
##########################################
...
##########################################
  ...
  def main(self):
    ...
    empas = input(
      '[?] File empas Luh Tod (contoh: empas.txt): '
    )
    if os.path.exists(
      empas
    ):
  ...
  def validate(self, user, with_proxy):
    try:
